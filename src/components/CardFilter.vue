<template>
	<div class="card p-1 mt-3">
        <div class="page-cover">
            <img :src="`${post.phone.media}`" alt="Denim Jeans" />
        </div>
    </div>
    <div class="card p-1">
        <div class="post-title mt-2 mb-1">{{post.title}}</div>
        <p class="price">
        <span class="bi bi-toman"></span>
        {{priceData}}
        </p>
...
<script>
	export default {
        ...
        setup(props){
            ...
            const priceData = price.toLocaleString('fa-IR')
